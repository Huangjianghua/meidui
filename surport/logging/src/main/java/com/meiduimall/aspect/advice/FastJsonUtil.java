...
public class FastJsonUtil {
    ...
    public static void main(String[] args) {
		//HashMap map = FastJsonUtil.deserialize("{id:'11',name:'rian',age:23}", HashMap.class);
		// System.out.println("============================"+map.get("id"));
		// System.out.println(FastJsonUtil.serialize(new HashMap[]{map}));
    /*	List<String> list=FastJsonUtil.deserializeList("['11','rian','23']", String.class);
