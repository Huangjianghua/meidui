...
public class BaseDaoImpl extends SqlSessionDaoSupport implements BaseDao {
	...
	public <T, P> T selectOne(P params, String sqlTag) {
		...
		try {
			...
			throw new DaoException(ServiceCatalogApiCode.UNKNOWN_ERROR, sqlTag + " error, params = " + params, e);
		}
		return rt;
	}
	...
	public <T> Integer insert(T t, String sqlTag) {
		...
		try {
			...
			throw new DaoException(ServiceCatalogApiCode.UNKNOWN_ERROR, sqlTag + " error, t = " + t, e);
		}
		return rt;
	}
	...
	public <T> Integer insertBatch(List<T> ts, String sqlTag) {
		...
		try {
			...
			throw new DaoException(ServiceCatalogApiCode.UNKNOWN_ERROR, sqlTag + " error, ts = " + ts, e);
		}
		return rt;
	}
