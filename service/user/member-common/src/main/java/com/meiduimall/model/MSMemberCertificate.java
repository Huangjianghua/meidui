...
public class MSMemberCertificate implements Serializable{
	...
	public String getMcerName() {
		return DESC.deyption(this.mcerName);
	}

	public void setMcerName(String mcerName) {
