...
public class MSMembers implements Serializable {
	...
	private static final long serialVersionUID = 6981052539871447969L;
	...
	private String memIsAllActivated;
	private String memCreatedDate;
	private String memUpdatedDate;
	...
	private String memCreatedCategory;
	...
	private String memLastLoginTime;
	...
	private String memBanDate;
	private String memIsConsumeReturnAll;
	private String memLoginTime;
	private String memChangePhoneDate;
	...
	public void setMemLicenseKey(String memLicenseKey) {
		this.memLicenseKey = memLicenseKey;
	}
	...
	public String getMemIsAllActivated() {
		return memIsAllActivated;
	}
	public void setMemIsAllActivated(String memIsAllActivated) {
	...
	public String getMemUpdatedDate() {
		return memUpdatedDate;
	}
	public void setMemUpdatedDate(String memUpdatedDate) {
	...
	public String getMemCreatedCategory() {
		return memCreatedCategory;
	}
	public void setMemCreatedCategory(String memCreatedCategory) {
	...
	public void setMemIntegralConsumeOriginal(String memIntegralConsumeOriginal) {
		this.memIntegralConsumeOriginal = memIntegralConsumeOriginal;
	}
	...
	public void setMemIntegralCurrentValidTradeIntetgral(String memIntegralCurrentValidTradeIntetgral) {
		this.memIntegralCurrentValidTradeIntetgral = memIntegralCurrentValidTradeIntetgral;
	}
	...
	public void setMemIntegralNextValidTradeIntegral(String memIntegralNextValidTradeIntegral) {
		this.memIntegralNextValidTradeIntegral = memIntegralNextValidTradeIntegral;
	}
	...
	public void setMemIntegralFistReturnIntegral(String memIntegralFistReturnIntegral) {
		this.memIntegralFistReturnIntegral = memIntegralFistReturnIntegral;
	}
	...
	public void setMemIntegralReturnedIntegral(String memIntegralReturnedIntegral) {
		this.memIntegralReturnedIntegral = memIntegralReturnedIntegral;
	}
	...
	public void setMemWalletUrl(String memWalletUrl) {
		this.memWalletUrl = memWalletUrl;
	}
	public String getMemLastLoginTime() {
		return memLastLoginTime;
	}
	public void setMemLastLoginTime(String memLastLoginTime) {
	...
	public String getMemBanDate() {
		return memBanDate;
	}
	public void setMemBanDate(String memBanDate) {
		this.memBanDate = memBanDate;
	}
	public String getMemIsConsumeReturnAll() {
		return memIsConsumeReturnAll;
	}
	public void setMemIsConsumeReturnAll(String memIsConsumeReturnAll) {
		this.memIsConsumeReturnAll = memIsConsumeReturnAll;
	}
	public String getMemLoginTime() {
		return memLoginTime;
	}
	public void setMemLoginTime(String memLoginTime) {
		this.memLoginTime = memLoginTime;
	}
	public String getMemChangePhoneDate() {
		return memChangePhoneDate;
	}
	public void setMemChangePhoneDate(String memChangePhoneDate) {
