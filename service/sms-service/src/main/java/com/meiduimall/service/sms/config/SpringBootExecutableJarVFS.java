...
//						 *
//						 * them. To work around that, as each line is read, try
//						 * to look it up via
//						 *
...
//	 * resource referenced
//	 *
//	 * by the URL. That is, assuming the URL references a JAR entry, this method
//	 * will return a URL
//	 *
...
//		} else {
//
//			// If the file part of the URL is itself a URL, then that URL
//			// probably points to the JAR
//
//			try {
//
//				for (;;) {
...
//
//				// This will happen at some point and serves as a break in the
//				// loop
//
//			}
//
...
//	 *            read. The buffer
//	 *
//	 *            must be at least the size of {@link #JAR_MAGIC}. (The same
