...
INSERT INTO `msg_template_info` VALUES ('9', '1', 'MEM_1002', '', '发送验证码', '【美兑壹购物】您的验证码是{VerificationCode}，10分钟内有效，请尽快完成验证。（如非本人操作，请忽略本短信）', 'MEMBER_SMS', '{VerificationCode}:验证码', 'system', '2017-01-13 10:27:34', '1mn');
