		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td style="text-align: left;">
				 <input type="text" id="userName"name="userName" value="${user.userName}" data-rule="帐号:required;username;length[4~20];">
				</td>
			</tr>
			<tr>
				<th class="td_right">昵称</th>
				<td style="text-align: left;">
				<input type="text" id="nickName"name="nickName" value="${user.nickName}" data-rule="昵称:required;nickname;length[2~20]">
				</td>
			</tr>
