...
<body>
  <form action="${ctx}/suggestWord/updateSuggestWord.do" method="post">
		<table class="table table-bordered">
			...
			<tr>
				<th class="td_right">提示词</th>
				<td style="text-align: left;">
					<input type="text" id="userName" name="userName"  data-rule="帐号:required;username;length[4~20];remote[${ctx}/user/checkUsername.do]" />
				</td>
			</tr>
			<tr>
				<th class="td_right">昵称</th>
				<td style="text-align: left;">
				<input type="text" id="nickName" name="nickName" data-rule="昵称:required;nickname;length[2~20]">
			  </td>
			</tr>
