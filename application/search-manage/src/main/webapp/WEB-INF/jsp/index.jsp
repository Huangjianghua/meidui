...
<title>${keyword}</title><meta name="keywords" content="${keyword}" /><meta name="description" content="壹购物综合网上购物商城笔记本__频道涵盖等商品的最新导购、报价、图片、型号等相关信息，为您提供最优质的网购生活！" /><link rel="icon" href="http://www.1gw.com/public/statics/favicon.ico" type="image/x-icon" />
<link rel="shortcut icon" href="http://www.1gw.com/public/statics/favicon.ico" type="image/x-icon" />
<script src="http://www.1gw.com/app/site/lang/zh_CN/js/lang.js?static"></script><script src="http://www.1gw.com/app/site/statics/scripts/first_header.js?static"></script>

<link href="http://www.1gw.com/app/topc/statics/stylesheets/topc_all.css?static" rel="stylesheet" media="screen, projection" /><script src="http://www.1gw.com/app/topc/statics/scripts/topc_header.js?static">
</script><link href="http://www.1gw.com/app/topc/statics/stylesheets/ui-dialog.css?static" rel="stylesheet" media="screen, projection" /><script src="http://www.1gw.com/app/topc/statics/scripts/dialog-min.js?static"></script>
<link rel="stylesheet" type="text/css" href="http://www.1gw.com/themes/newfirst/images/style.css?v=424" />
<!-- <link rel="stylesheet" type="text/css" href="http://www.1gw.com/themes/newfirst/images/style.css?v=424" /> -->
<link rel="stylesheet" type="text/css" href="http://www.1gw.com/themes/newfirst/images/home/css/index.css"/>
<script type="text/javascript" src="http://www.1gw.com/themes/newfirst/images/home/js/site.js"></script>
<script type="text/javascript" src="http://www.1gw.com/themes/newfirst/images/home/js/jquery.lazyload.js"></script>
<!-- 百度主动推送工具 -->
<script>
 (function(){ 
...
<div class="neirong">
 <form action="http://www.1gw.com/cart-checkout.html" method="post" class="cart-submit-form">
		<div class="fmbox">
	</div>
</form>
</div>
	<div class="total_cart">
		<div class="total_cart1">
			<div class="left">
				<p>
					<a href="http://www.1gw.com/cart.html">去购物车</a>
				</p>
			</div>
			<div class="right">
		...
		<div class="total_btn">
			<p>
				<a href="http://www.1gw.com/cart.html" id="cart_counts">立即结算</a>
			</p>
		</div>
	</div>
...
<ul id="navs">
	<li class="hasdrop">
		...
		<div class="drop swx"><strong></strong>
			<div class="pic"><img src="http://www.1gw.com/themes/first/images/images/ewm_pic1.png" /><u>扫一扫关注公众号</u></div>
	...
	<li class="hasdrop">
		...
		<div class="txt">
							<a href="http://www.1gw.com/member-index.html">会员中心</a>
		    		</div>
		</div>
	</li>
	<li class="hasdrop">
		...
		<div class="drop"><strong></strong>
		<div class="txt">
							<a href="http://www.1gw.com/member-collectitems.html">我的收藏</a>
		    		</div>
		</div>
	</li>
...
//function cartMsg(){
    ...
    var checkCart = {
            updateItem : function(el){
                ...
                $.ajax({
                    url:'http://www.1gw.com/cart-update.html',
                    type:'POST',
                    data: data,
                    success:function(re) {
                        if(re){
            ...
            updateAll : function(){
                var data = $('#cart_main_min .cart-submit-form').serialize();
                $.ajax({
                    url:'http://www.1gw.com/cart.html',
                    type:'POST',
                    data:data,
                    success:function(rs){
            ...
            deleteItem : function(id){
                if(id){
                    $.ajax({
                        url:'http://www.1gw.com/cart-remove.html',
                        type:'POST',
                        data:'cart_id['+id+']=1',
                        success:function(rs){
...
<div id="main" class="main clearfix">
  <div class="wrap-lg">
		<c:set var="url" value="search.do?" />
    <c:if test="${!empty keyword }">
		<c:set var="url" value="${url }&keyword=${keyword }" />
    </c:if>
    <c:if test="${!empty brand }">
		<c:set var="url" value="${url }&brand=${brand.brandId }" />
    </c:if>
    <c:if test="${!empty cat }">
		<c:set var="url" value="${url }&cid3=${cat.catId }" />
    </c:if>
    <c:if test="${!empty price }">
		<c:set var="url" value="${url }&price=${price }" />
    </c:if>
    
    <%@ include file="/WEB-INF/jsp/include/bread_crumbs.jsp" %>
...
<!---网站底部结束-->
<script charset="utf-8" language="javascript" type="text/javascript" src="http://www.1gw.com/themes/newfirst/images/first.js"></script>
<script>
	//图片懒加载
	$(function() {
