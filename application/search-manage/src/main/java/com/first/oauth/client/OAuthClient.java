...
package com.first.oauth.client;
...
import com.first.oauth.OAuthProblemException;
import com.first.oauth.ParameterStyle;
import com.first.oauth.http.HttpClient;
import com.first.oauth.http.HttpMessage;
import com.first.oauth.http.HttpMessageDecoder;
import com.first.oauth.http.HttpResponseMessage;
import com.first.oauth.signature.OAuthSignatureMethod;
