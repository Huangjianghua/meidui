...
import com.meiduimall.application.search.manage.Listener.SysInitListener;
import com.meiduimall.application.search.manage.filter.ServletFilter;
import com.meiduimall.application.search.manage.inteceptor.AdminInteceptor;
import com.meiduimall.application.search.manage.servlet.GetValidateCodeServlet;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new AdminInteceptor()).addPathPatterns("/**");
