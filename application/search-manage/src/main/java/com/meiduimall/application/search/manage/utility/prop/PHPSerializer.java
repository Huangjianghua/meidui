...
public class PHPSerializer {
    ...
    private static int writeObject(ByteArrayOutputStream stream, Object obj, HashMap ht, int hv, String charset) {
        ...
        if (obj instanceof java.io.Serializable) {
            ...
            if (obj instanceof com.meiduimall.application.search.manage.utility.prop.Serializable) {
                byte[] cs = ((com.meiduimall.application.search.manage.utility.prop.Serializable) obj).serialize();
    ...
    private static UnSerializeResult readCustomObject(ByteArrayInputStream stream, HashMap ht, int hv, String charset) {
        ...
        if (o == null) {
            stream.skip(n);
        } else if (o instanceof com.meiduimall.application.search.manage.utility.prop.Serializable) {
            byte[] b = new byte[n];
 
            stream.read(b, 0, n);
            ((com.meiduimall.application.search.manage.utility.prop.Serializable) o).unserialize(b);
        } else {
            stream.skip(n);
        }
        stream.skip(1);
