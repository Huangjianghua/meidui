...
public class AlipayConfig {
	...
	public static final String privateKey = "MIICdgIBADANBgkqhkiG9w0BAQEFAASCAmAwggJcAgEAAoGBAMq5VTcNTQU8eRyX"
	...
	public static final String sellerId = "gcmepay@qq.com" ;

	// 支付宝的公钥,查看地址：https://b.alipay.com/order/pidAndKey.htm
	public static final String alipayPublicKey  = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCnxj/9qwVfgoUh/y2W89L6BkRA"
										 	 +"FljhNhgPdyPuBV64bfQNN1PjbCzkIM6qRdKBoLPXmKKMiFYnkd6rAoprih3/PrQE"
											 +"B/VsW8OoM8fxn67UDYuyBTqA23MML9q1+ilIZwBC2AQ2UBVOrFXfFl75p6/B5Ksi"
											 +"NG9zpgmLCUYuLkxpLQIDAQAB";

	// 调试用，创建TXT日志文件夹路径
	public static final String logPath = "D:\\";
	...
	public static final String notifyUrl = "http://xxxxxxxx/xxxxxxx/notify/payNotify" ;
}
