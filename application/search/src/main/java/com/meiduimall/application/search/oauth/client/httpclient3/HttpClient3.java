...
package com.meiduimall.application.search.oauth.client.httpclient3;
...
import com.meiduimall.application.search.oauth.http.HttpMessage;
import com.meiduimall.application.search.oauth.http.HttpResponseMessage;

/**
 * Utility methods for an OAuth client based on the Jakarta Commons HTTP client.
 * 
 */
public class HttpClient3 implements com.meiduimall.application.search.oauth.http.HttpClient {
