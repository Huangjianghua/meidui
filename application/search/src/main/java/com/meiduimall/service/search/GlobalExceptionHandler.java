...
import com.meiduimall.service.search.constant.ServiceSearchApiCode;
 ...
 * @author yangchangfu
 */
@ControllerAdvice(basePackages = "com.meiduimall.service.search.controller")
@ResponseBody
public class GlobalExceptionHandler {
	...
	public Object methodJsonArgumentNotValidHandler(HttpServletRequest request,
		...
		return new ResBodyData(ServiceSearchApiCode.REQUEST_PARAMS_ERROR,
				ServiceSearchApiCode.getZhMsg(ServiceSearchApiCode.REQUEST_PARAMS_ERROR),
	...
	public Object apiExceptionHandler(HttpServletRequest request, ApiException exception) {
		return new ResBodyData(exception.getCode(), ServiceSearchApiCode.getZhMsg(exception.getCode()),
				JsonUtils.getInstance().createObjectNode());
	}
